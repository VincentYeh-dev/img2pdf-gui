...
import org.vincentyeh.img2pdf.model.util.file.FileNameFormatter;
import org.vincentyeh.img2pdf.model.util.file.FileSorter;
import org.vincentyeh.img2pdf.model.util.file.GlobbingFileFilter;
import org.vincentyeh.img2pdf.model.util.interfaces.NameFormatter;
...
//                            JOptionPane.showMessageDialog(null, e.getCause().getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
    ...
    public void convert(String owner_password, String user_password) {
        try {
            File tempFolder = Files.createTempDirectory("org.vincentyeh.img2pdf").toFile();
