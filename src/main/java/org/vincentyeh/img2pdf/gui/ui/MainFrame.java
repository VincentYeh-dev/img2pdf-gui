...
public class MainFrame {
    ...
    private void startConversion() {
        try {
            ...
            MemoryUsageSetting setting = MemoryUsageSetting.setupMixed(200 * 1024 * 1024).setTempDir(tempFolder);

            ImagePDFFactory factory = new ImagePDFFactory(getPageArgument(), getDocumentArgument(), new PDFBoxBuilder(setting), ImageReaderFacade.getImageReader(getColorType()), new StandardImagePageCalculationStrategy(), true);
